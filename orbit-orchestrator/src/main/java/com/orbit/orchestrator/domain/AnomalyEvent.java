...
public class AnomalyEvent {
    ...
    public double getTelemetryValue() {
    ...
    public static AnomalyEventBuilder builder() {
    ...
    public static class AnomalyEventBuilder {
        ...
        public AnomalyEventBuilder eventId(UUID eventId) {
            this.eventId = eventId;
            return this;
        }

        public AnomalyEventBuilder deviceId(String deviceId) {
            this.deviceId = deviceId;
            return this;
        }

        public AnomalyEventBuilder severity(Severity severity) {
            this.severity = severity;
            return this;
        }

        public AnomalyEventBuilder detectedAt(Instant detectedAt) {
            this.detectedAt = detectedAt;
            return this;
        }

        public AnomalyEventBuilder ruleTriggered(String ruleTriggered) {
            this.ruleTriggered = ruleTriggered;
            return this;
        }

        public AnomalyEventBuilder description(String description) {
            this.description = description;
            return this;
        }

        public AnomalyEventBuilder telemetryValue(double telemetryValue) {
            this.telemetryValue = telemetryValue;
            return this;
        }

        public AnomalyEventBuilder metricType(String metricType) {
            this.metricType = metricType;
            return this;
        }
